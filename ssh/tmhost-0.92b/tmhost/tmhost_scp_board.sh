...
PROG=`basename $0`
USAGE="Usage: $PROG [--help] [-l] [[-x hostname] ...] hostgroup localfile destdir

EXAMPLES:
  $PROG \"GROUP=galaxyhost TYPE=online\" /home/admin/aaa /home/admin/app/cai/conf
"  
...
do
    ...
    *)
				...
				echo
        {
                ...
                npscp_board $BOARD_FILE $host:$2 onboard 3>&2 2>&1 1>&3 \
                    |    awk '
/^\*\*/ {
                if (skip) {
                        print
