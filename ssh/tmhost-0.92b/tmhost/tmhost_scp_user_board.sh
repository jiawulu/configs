...
PROG=`basename $0`
USAGE="Usage: $PROG [--help] [-l] [[-x hostname] ...] hostgroup asuser localfile destdir

EXAMPLES:
  $PROG \"GROUP=galaxyhost TYPE=online\" admin /home/admin/aaa /etc/
"
...
do
    ...
    *)
				...
				echo
        {
                ...
                bscp_board $host $1 $BOARD_FILE $3  onboard 3>&2 2>&1 1>&3 \
                    |    awk '
/^\*\*/ {
                if (skip) {
                        print
